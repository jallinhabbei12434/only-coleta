document.addEventListener("DOMContentLoaded", () => {
  ...
  function mostrarPopupEspera() {
    ...
    waitModal.innerHTML = `
      <div class="modal-content">
        <div class="modal-body wait-modal-body">
          ...
          <p>Redirecionando em <span id="waitCountdown">5</span> segundos.</p>
    ...
    // Reduzido para 5 segundos no modo de teste
    let segundos = 5
  ...
  // Confirmar telefone e prosseguir - VERSÃO DE TESTE SEM WEBHOOK
  if (confirmPhoneBtn) {
    ...
    `
      ...
      try {
        // Simular 2 segundos de carregamento (reduzido para teste)
        ...
        // MODO DE TESTE: Sempre continuar com o fluxo
        const userData = {
